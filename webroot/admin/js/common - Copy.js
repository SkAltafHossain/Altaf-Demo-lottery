            ...
            $("#form1").steps({
                ...
                onStepChanged: function (event, currentIndex, priorIndex)
                {
                    ...
                    if(currentIndex==4){
                        ...
                        if($("#dis_amount").val().length != 0)
                        {
                        var reason = $("#discount_reason").val();
                        
                       
                        window.setTimeout(function(){
                        $('#before_append').html("<label><strong>Discount Reason: </strong></label><div><span id='show_less1_span' style='cursor: pointer;' onclick='show_more1(\""+reason+"\")' >"+reason.substring(0,20)+"<span class='data-more'>"+reason.substring(0,20)+"<br><b style='color:blue'>more</b></span></span><span style='display: none; cursor: pointer;' id='show_full1_span' onclick='show_less1(\""+reason+"\")'><span class='data-more'>"+reason+"<br><b style='color: blue'>less</b></span></span> </div><br>");
                        },500);                      

                        }else{
                            document.getElementById('discount_reason').value='N/A';
...
$(document).ready(function(){
    ...
    function common_status_change(transid) {  
        ...
        // function show_more1(transid) {
        // $('#show_full1_'+transid).show();
        // $('#show_less1_'+transid).hide();
        // $("#before_append").css('overflow-x','scroll');
        // }
        // function show_less1(transid) {
        // $('#show_less1_'+transid).show();
        // $('#show_full1_'+transid).hide();
        // $("#before_append").css('overflow','hidden');
        // }
...
$("#discount_reason").keypress(function (e) {
        var regex = new RegExp("^[a-zA-Z  0-9]+$");
        var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
        if (regex.test(str)) {
            return true;
