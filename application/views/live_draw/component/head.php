...
<html lang="en">
	<head> 
		...
		<link rel="icon" href="<?=base_url()?>webroot/live_draw/assets/images/logo_new.svg">
		<meta charset="utf-8">
		<title>Lottery</title>
...
#result_div_2{
  background-image: linear-gradient(rgb(32, 22, 232), rgb(16, 5, 225));
  position: relative;
  bottom: 994px;
  width: 100%;
  height: 95px;
