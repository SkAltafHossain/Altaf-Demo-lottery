...
<html lang="en">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-QNPPL18CXB"></script>
    <script>
  ...
  <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="" crossorigin="anonymous"/>
		...
		<script type="text/javascript" src="<?=base_url()?>webroot/user/js/responsivevoice.js"></script>
		<style>
