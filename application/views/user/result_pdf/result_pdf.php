...
<body>
    <table border="0" width="100%" height="100%" style="padding-bottom: 15px;">  
        <tr>  
            <td><img src="<?=base_url('webroot/user/images/logo_chagol.png')?>" id="left_logo"> </td>
            <td align="center">
                <table>
                    <tr>
                        <td>
    ...
    <div id="div_last" align="center">
        ...
        <div align="center"><span id="div4"><?=$result_pdf->drow_number?> Draw held on  <?=$result_pdf->date_1 ?>   Price ₹10/-</span></div>
