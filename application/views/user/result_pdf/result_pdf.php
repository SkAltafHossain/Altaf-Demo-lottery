...
<body>
        ...
        <tr>  
            ...
            <td align="center">
                <table>
                    <tr>
                        <td>
                            <span id="header_text" style="font-weight: bold;">Hariana State Lottery</span>
                        </td>
    ...
    <div id="div_last" align="center">
        <div class="row" style="margin-top: 15px; margin-left: 20px; margin-right: 20px;">
          ...
          <div class="column middle" style = "text-align: center;"><span id="div1">Hariana State Lottery</span></div>
    ...
    <div align="center">
        <div align="center" style="padding-top: 15px; padding-bottom: 8px;"><span id="div7">ISSUED BY:THE DIRECTOR Hariana State Lottery</span></div>
