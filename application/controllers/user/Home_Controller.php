...
// 		print_r($this->data);die();
    ...
    {
        $this->data['page_title'] = 'Privacy Policy | Manipur Singham Lottery';
    ...
    public function last_digit()
    {
        ...
        $this->data['page_title'] = 'First Prize Last Digit | Manipur Singham Lottery';
    ...
    public function last_two_digit()
    {
        ...
        $this->data['page_title'] = 'First Prize Last Two Digits | Manipur Singham Lottery';
